...
最后更新：2026-08-30（T1.5 MCP 管理前端页面完成后）
...
| ID | 任务 | 状态 | 备注 |
|---|---|---|---|
| T1.1 | 数据模型与数据库迁移 | 已完成 | 详见 HANDOFF.md 对应记录 |
| T1.2 | Skill Service（zip 存取 + CRUD API） | 已完成 | 2026-08-30 由覆盖更新改为保存版本历史 + 支持回滚，详见 HANDOFF.md |
| T1.3 | Skill 管理前端页面 | 已完成 | 2026-08-30 按反馈做了交互优化（抽屉+嵌套树+编辑器滚动），详见 HANDOFF.md |
| T1.4 | MCP Service（CRUD API） | 已完成 | 详见 HANDOFF.md 对应记录 |
| T1.5 | MCP 管理前端页面 | 已完成 | 详见 HANDOFF.md 对应记录 |
