...
# 汇总导入所有模块的 models.py，确保 Base.metadata 在 autogenerate 时包含全部表
...
from app.modules.sessions import models as sessions_models  # noqa: F401
...
# 不在 alembic.ini 里硬编码连接串，复用项目统一的环境变量配置方式（app.config.get_settings）
